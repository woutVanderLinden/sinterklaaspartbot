let createScene = function () {
	...
	let camera = new BABYLON.UniversalCamera("MyCamera", new BABYLON.Vector3(-2, 0.5, 1), scene);
	camera.minZ = 0.0001;
	...
	let sphere = BABYLON.MeshBuilder.CreateSphere("dummyCamera", { radius: 0.5 }, scene);
	...
	let box = new BABYLON.MeshBuilder.CreateBox("crate", { size: 1, height: 2 }, scene);
	box.material = new BABYLON.StandardMaterial("Mat", scene);
	let boxDiffuse = new BABYLON.Texture("https://raw.githubusercontent.com/BabylonJS/Babylon.js/master/Playground/textures/crate.png", scene);
