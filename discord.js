exports.handler = async message => {
  ...
  if (message.mentions && message.mentions.users && message.mentions.users.has('BLANK')) return message.channel.send(`Hi, I'm ${Bot.status.nickName}! I'm a bot by ${config.owner}. My command character is \`\`\`${prefix}\`\`\`.`);
