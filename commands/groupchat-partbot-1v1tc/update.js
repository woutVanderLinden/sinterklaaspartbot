			...
			case 'experts7': {
				let readline = require('readline');
					...
					function updateExperts(auth) {
						...
						let eout = fs.readFileSync('./data/EXPERTS/tc7.js', 'utf8');
						Bot.log(eout);
					...
					case 'tc': {
						...
						function updateVR(auth) {
							...
							docs.documents.get({
								...
								let eout = fs.readFileSync(`./data/VR/TC7/${giventype}.js`);
								Bot.log(String(eout));
			...
			case 'samples7': case 'ss7': case 'samplesets7': {
				...
				function doStuff(auth) {
					...
					request(rlink, function(e, response, body) {
						...
						let sampleObj = JSON.parse(fs.readFileSync('./data/SAMPLES/TC7/sets.json', 'utf8'));
