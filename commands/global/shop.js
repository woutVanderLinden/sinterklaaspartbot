module.exports = {
	...
	commandFunction: function (Bot, room, time, by, args, client) {
		...
		if (args[0] && toId(args[0]) == 'full') {
			if (tools.hasPermission(by, 'gamma', room)) return Bot.say(room, `http://partbot.glitch.me/${room}-shop/`);
			else return Bot.pm(by, `http://partbot.glitch.me/${room}-shop/`);
		}
