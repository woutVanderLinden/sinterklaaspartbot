module.exports = {
	...
	commandFunction: function (args, message, Bot) {
		if (!message.member.roles.cache.find(r => r.id === '729994253865844806')) return message.channel.send('ACCESS DENIED - why do you know about this :sus:').then(msg => msg.delete({timeout: 3000}));
