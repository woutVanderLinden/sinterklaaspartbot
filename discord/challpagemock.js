...
module.exports = {
	...
	commandFunction: function (args, message, Bot) {
		fs.writeFile('./public/hofmock.html', page, e => {
			...
			// tools.uploadToPastie(JSON.stringify(playerData, null, "\t"), url => message.channel.send(url));
		});
	}
}