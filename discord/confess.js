module.exports = {
	...
	commandFunction: function (args, message, Bot) {
		...
		if (!client.guilds.cache.get('773859244163465223').members.cache.get(message.author.id)) return message.channel.send('You are not in the IIT KGP server!');
		let channel = client.channels.cache.get('781114745713066034');
		let content = args.join(' ').replace(/```/g, '');
